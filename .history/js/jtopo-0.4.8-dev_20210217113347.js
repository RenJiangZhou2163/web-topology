!
        ...
        this.initialize = function() {
          this.elementType = 'element',
            ...
            this.restore = function() {
              if (null != this.propertiesStack && 0 !=
          ...
          JTopo = {
            ...
            replaceStageWithJson: function(jsonObj) {
              ...
              for (let k in jsonObj) {
                if ('childs' != k) {
                  stage[k] = jsonObj[k];
                  if (k == 'deviceNum' || k == 'wheelZoom' || k == 'frames' ||
                      k == 'height' || k == 'width') {
              ...
              return scenes.forEach(function(a) {
                ...
                for (let c in a) {
                  if ('childs' != c) {
                    if (a[c] == 'undefined') {
                      b[c] = undefined;
                    } else if (c == 'translateX' || c == 'translateY' || c ==
                        'scaleX' || c == 'scaleY') {
                      b[c] = parseFloat(a[c]);
                    } else {
                      b[c] = a[c];
                ...
                d.forEach(function(a) {
                  ...
                  if ('node' == d) {
                    ...
                    c.visible = editor.config.nodeVisible;
                    c.dragable = true;
                    c.selected = false;
                    c.showSelected = true;
                    c.isMouseOver = false;
                  ...
                  for (let e in a) {
                    ...
                    if (c) {
                      if (a[e] == 'undefined') {
                        c[e] = undefined;
                        continue;
                      } else if (e == 'rotate' || e == 'scaleX' || e ==
                          'scaleY' || e == 'zIndex' || e == 'x' || e == 'y'
                          || e == 'width' || e == 'height') {
                        c[e] = parseFloat(a[e]);
                      } else {
                        c[e] = a[e];
                ...
                d.forEach(function(a) {
                  ...
                  if ('link' == d) {
                    ...
                    if (nodeA && nodeZ) {
                      ...
                      c.lineJoin = editor.config.linkLineJoin;
                    ...
                    if (a['childNodes']) {
                      ...
                      if (temp && temp.length > 0) {
                        ...
                        for (let ni = 0; ni < temp.length; ni++) {
                          b.childs.forEach(function(n) {
                            if (n instanceof JTopo.Node && n.nodeId ==
                                temp[ni]) {
                              c.add(n);
                            }
                          });
    ...
    function(JTopo) {
            ...
            for (var scenes = obj.scenes, i = 0; i < scenes.length; i++) {
              ...
              for (var p in sceneObj)
                if ('elements' != p)
                  ...
                  for (var nodeMap = {}, elements = sceneObj.elements, m = 0; m <
                  elements.length; m++) {
      ...
      function toJson(a) {
        ...
        for (var e = 0; e < a.childs.length; e++) {
          ...
          for (var g = 0; g < f.childs.length; g++) {
            var h = f.childs[g];  // g 可以是 container
            g > 0 && (d += ','),
                d += '{',
                d += getProperties(h, c),
                d += '}';
      ...
      function changeColor(a, b, c, d, e) {
        ...
        for (var h = a.getImageData(0, 0, b.width,
            b.height), i = h.data, j = 0; f > j; j++)
          for (var k = 0; g > k; k++) {
            var l = 4 * (j + k * f);
      ...
      function getOffsetPosition(a) {
        ...
        if ('getBoundingClientRect' in document.documentElement)
          var d = a.getBoundingClientRect(),
              ...
              b = d.top +
                  (self.pageYOffset || g && g.scrollTop || f.scrollTop) - h,
              c = d.left +
                  (self.pageXOffset || g && g.scrollLeft || f.scrollLeft) - i;
        else
          do
            b += a.offsetTop || 0,
                c += a.offsetLeft || 0,
    ...
    function(JTopo) {
        ...
        return {
          ...
          getImage: function(b, c) {
            ...
            return a.childs.length > 0 && (g.save(),
                g.clearRect(0, 0, this.exportCanvas.width,
          ...
          getData: function(b, c) {
            ...
            if (a.childs.length > 0) {
              ...
              var f = d(a.childs[0]),
                  g = f.translateX * (this.canvas.width / a.canvas.width) *
                      a.childs[0].scaleX,
                  h = f.translateY * (this.canvas.height / a.canvas.height) *
                      a.childs[0].scaleY,
                  i = a.getBound(),
              ...
              // 画鹰眼区拖放的长方形小块
              e.strokeRect(-g, -h, e.canvas.width * j,
                  e.canvas.height * k), e.restore();
              var l = null;
              try {
          ...
          paint: function() {
            if (null != this.eagleImageDatas) {
              ...
              b.save(),
                  ...
                  b.fillRect(a.canvas.width - this.canvas.width - 2 * this.hgap,
                  ...
                  b.rect(a.canvas.width - this.canvas.width - 2 * this.hgap,
                      a.canvas.height - this.canvas.height - 1,
                      a.canvas.width - this.canvas.width,
                      this.canvas.height + 1),
                  b.stroke(),
          ...
          eventHandler: function(a, b, c) {
            ...
            // 操作点位于鹰眼区域
            if (d > c.canvas.width - this.canvas.width && e > c.canvas.height -
                this.canvas.height) {
              if (
      ...
      function Stage(c) {
        ...
        function i(a) {
          ...
          var b = d(a);
          stage.mouseDown ?
              0 == a.button && (b.dx = b.x - stage.mouseDownX,
        ...
        function l(a) {
          ...
          (a.preventDefault ? a.preventDefault() : (a = a || window.event,
              a.returnValue = !1),
          1 == stage.eagleEye.visible && stage.eagleEye.update());
        }
        ...
        function initJtopoEvent(b) {
          ...
          (window.addEventListener('keydown', function(b) {
            ...
            var c = b.keyCode;
            (37 == c || 38 == c || 39 == c || 40 == c) &&
            (b.preventDefault ? b.preventDefault() : (b = b || window.event,
                b.returnValue = !1));
          }, !0),
        ...
        this.dispatchEventToScenes = function(eventType, event) {
          ...
          if (
            ...
            var c = event.x, d = event.y;
            if (c > this.width - this.eagleEye.width && d > this.height -
                this.eagleEye.height)
              return void this.eagleEye.eventHandler(eventType, event,
                  this);
          }
          // 对每个scene对象调用事件处理函数
          this.childs.forEach(function(c) {
            if (1 == c.visible) {
              ...
              if (null == d)
                throw new Error(
                    'Function not found:' + eventType + 'Handler');
              d.call(c, event);
            }
          });
        },
        ...
        q.forEach(function(a) {
          r[a] = function(b) {
            ...
            this.saveImageInfo = function(a, b) {
              let c = this.eagleEye.getImage(a, b),
                  d = window.open('about:blank');
              return d.document.write(
                  '<img src=\'' + c + '\' alt=\'from canvas\'/>'),
                  this;
            },
            ...
            this.repaint = function() {
              0 != this.frames &&
              (this.frames < 0 && 0 == this.needRepaint || (this.paint(),
            ...
            setTimeout(function() {
              stage.mousewheel(function(a) {
                ...
                null != this.wheelZoom && (b > 0 ?
                    this.zoomOut(this.wheelZoom) :
                    this.zoomIn(this.wheelZoom));  // 鼠标中键上下滚动与放大缩小的关系
              }),
                  stage.paint();
            }, 300),
      ...
      function Scene(c) {
        ...
        null != c && (c.add(this),
            ...
            this.paintBackgroud = function(a) {
              null != this.background ?
                  a.drawImage(this.background, 0, 0, a.canvas.width,
                      a.canvas.height) :
                  (a.beginPath(),
                      a.fillStyle = 'rgba(' + this.backgroundColor + ',' +
                          this.alpha + ')',
            ...
            this.paintChilds = function(b) {
              for (var c = 0; c < this.zIndexArray.length; c++)
                for (var d = this.zIndexArray[c], e = this.zIndexMap[d], f = 0; f <
                e.length; f++) {
                  var g = e[f];
            ...
            this.isVisiable = function(b) {
              ...
              return d > this.stage.canvas.width || e >
              this.stage.canvas.height || 0 > f || 0 > g ? !1 : !0;
            },
            ...
            this.getElementByXY = function(b, c) {
              for (var d = null, e = this.zIndexArray.length - 1; e >= 0; e--)
                for (var f = this.zIndexArray[e], g = this.zIndexMap[f], h = g.length -
                    1; h >= 0; h--) {
                  var i = g[h];
                  if (i instanceof JTopo.InteractiveElement &&
                      this.isVisiable(i) && i.isInBound(b, c))
                    return d = i;
                }
              return d;
            },
            ...
            this.remove = function(b) {
              ...
              c &&
              (this.zIndexMap[b.zIndex] = JTopo.util.removeFromArray(c, b)),
            ...
            this.removeFromSelected = function(a) {
              for (var b = 0; b < this.selectedElements.length; b++) {
                ...
                a === c &&
                (this.selectedElements = this.selectedElements.del(b));
              }
            },
            ...
            this.selectElement = function(a) {
              ...
              if (null != b)
                if (a.target = b, b.mousedownHander(a), b.selectedHandler(
                    a), e.notInSelectedNodes(b))
            ...
            this.mousedownHandler = function(b) {
              ...
              this.mode == JTopo.SceneMode.normal)
                ...
                this.mode == JTopo.SceneMode.select ?
                    this.selectElement(c) :
                    this.mode == JTopo.SceneMode.edit && (this.selectElement(c),
                    (null == this.currentElement || this.currentElement instanceof
                        JTopo.Link) && 1 == this.translate &&
                    (this.lastTranslateX = this.translateX,
                        this.lastTranslateY = this.translateY));
                  ...
                  this.mode == JTopo.SceneMode.drag ?
                      ...
                      this.mode == JTopo.SceneMode.select ?
                          null != this.currentElement ?
                              1 == this.currentElement.dragable &&
                              this.dragElements(c) :
            ...
            this.areaSelectHandle = function(a) {
              ...
              for (var m = h + j, n = i + k, o = 0; o < e.childs.length; o++) {
                var p = e.childs[o];
                p.x > h && p.x + p.width < m && p.y > i && p.y + p.height < n &&
                e.notInSelectedNodes(p) && (p.selectedHandler(a),
                    e.addToSelected(p));
              }
            },
            ...
            this.mousemoveHandler = function(b) {
              ...
              null != d ?
                  (e.mouseOverelement && e.mouseOverelement !== d &&
                  (c.target = d,
        ...
        return f.forEach(function(a) {
          g[a] = function(b) {
            ...
            this.zoomOut = function(a) {
              0 != a &&
              (null == a && (a = .8), this.scaleX /= a, this.scaleY /= a);
            },
            ...
            this.paint = function(a) {
              a.beginPath(),
                  a.fillStyle = 'rgba(' + this.fillColor + ',' + this.alpha +
                      ')',
                  a.rect(-this.width / 2, -this.height / 2, this.width,
                      this.height),
                  a.fill(),
                  a.stroke(),
                  a.closePath();
          ...
          //this.serializedProperties = this.serializedProperties.concat(a)
            ...
            this.paintSelected = function(a) {
              0 != this.showSelected && (a.save(),
                  ...
                  a.rect(-this.width / 2 - 3, -this.height / 2 - 3,
            ...
            this.isInBound = function(a, b) {
              return a > this.x && a < this.x + this.width *
                  Math.abs(this.scaleX) && b > this.y && b < this.y +
            ...
            this.dispatchEvent = function(a, b) {
              return this.messageBus ?
                  (this.messageBus.publish(a, b), this) :
                  null;
            },
            this.removeEventListener = function(a) {
              this.messageBus.unsubscribe(a);
          ...
          if (0 != this.editAble) {
            ...
            this.mousedragHandler = function(a) {
              ...
              if (null == this.selectedPoint) {
                ...
                // 画标尺线
                // CHANGE：2021-2-9 15:58:23 不需要标尺线，去除
                // editor.utils.createRuleLines(b + this.width / 2,
                //     c + this.height / 2);
    ...
    function(a) {
              ...
              if (this.image) {
                ...
                a.globalAlpha = this.alpha,
                    null != this.image.alarm && null != this.alarm ?
                        a.drawImage(this.image.alarm, -this.width / 2,
                            -this.height / 2, this.width, this.height) :
                        a.drawImage(this.image, -this.width / 2,
                            -this.height / 2, this.width, this.height),
                    a.globalAlpha = b;
              } else
                a.beginPath(),
                    ...
                    null == this.borderRadius || 0 == this.borderRadius ?
                        a.rect(-this.width / 2, -this.height / 2, this.width,
                            this.height) :
                        a.JTopoRoundRect(-this.width / 2, -this.height / 2,
            ...
            this.paintAlarmText = function(a) {
              if (null != this.alarm && '' != this.alarm) {
                ...
                a.strokeStyle = 'rgba(' + b + ', ' + c + ')',
                    ...
                    a.closePath(),
                    a.beginPath(),
                    a.strokeStyle = 'rgba(' + this.fontColor + ', ' +
                        this.alpha + ')',
            ...
            this.paintBorder = function(a) {
              if (0 != this.borderWidth) {
                a.beginPath(),
                    ...
                    a.strokeStyle = 'rgba(' + this.borderColor + ',' +
                        this.alpha + ')';
                var b = this.borderWidth / 2;
                null == this.borderRadius || 0 == this.borderRadius ?
                    a.rect(-this.width / 2 - b, -this.height / 2 - b,
                        this.width + this.borderWidth,
                        this.height + this.borderWidth) :
                    a.JTopoRoundRect(-this.width / 2 - b, -this.height / 2 - b,
                        this.width + this.borderWidth,
            ...
            this.paint = function(a) {
              a.beginPath(),
                  ...
                  this.isVisited && null != this.visitedColor ?
                      (a.strokeStyle = 'rgba(' + this.visitedColor + ', ' +
                          this.alpha + ')',
                          a.fillStyle = 'rgba(' + this.visitedColor + ', ' +
                              this.alpha + ')') :
                      (a.strokeStyle = 'rgba(' + this.fontColor + ', ' +
                          this.alpha + ')',
                          a.fillStyle = 'rgba(' + this.fontColor + ', ' +
                              this.alpha + ')'),
                  a.fillText(this.text, -this.width / 2, this.height / 2),
        ...
        this.initialize(arguments),
            ...
            this.paint = function(a) {
              a.save(),
                  ...
                  a.fillStyle = 'rgba(' + this.fillColor + ',' + this.alpha +
                      ')',
                  a.arc(0, 0, this.radius, this.beginDegree, this.endDegree,
                      !0),
                  a.fill(),
                  a.closePath(),
                  a.restore(),
            ...
            this.paintSelected = function(a) {
              a.save(),
                  ...
                  a.strokeStyle = 'rgba(168,202,255, 0.9)',
                  a.fillStyle = 'rgba(168,202,236,0.7)',
                  a.arc(0, 0, this.radius + 3, this.beginDegree, this.endDegree,
                      !0),
                  a.fill(),
                  a.stroke(),
                  a.closePath(),
      ...
      function i() {
        var a = null;
        return a = arguments.length <= 3 ?
            new g(arguments[0], arguments[1], arguments[2]) :
            new h(arguments[0], arguments[1], arguments[2], arguments[3],
      ...
      function f(b, c, g) {
        ...
        this.initialize = function(b, c, d) {
          ...
          0 != arguments.length) {
            ...
            this.nodeA && null == this.nodeA.outLinks &&
            (this.nodeA.outLinks = []),

            this.nodeA && null == this.nodeA.inLinks &&
            (this.nodeA.inLinks = []),

            this.nodeZ && null == this.nodeZ.inLinks &&
            (this.nodeZ.inLinks = []),

            this.nodeZ && null == this.nodeZ.outLinks &&
            (this.nodeZ.outLinks = []),
            ...
            this.removeHandler = function() {
              ...
              this.nodeA && this.nodeA.outLinks &&
              (this.nodeA.outLinks = this.nodeA.outLinks.filter(function(b) {
                return b !== a;
              })),
              this.nodeZ && this.nodeZ.inLinks &&
        ...
        this.initialize = function() {
          ...
          this.serializedProperties.push('direction');
            ...
            this.getStartPosition = function() {
              ...
              return 'horizontal' == this.direction ?
                  a.x = this.nodeZ.cx < a.x ?
                      this.nodeA.x :
                      this.nodeA.x + this.nodeA.width :
                  a.y = this.nodeZ.cy < a.y ?
                      this.nodeA.y :
      ...
      function b(c) {
        this.initialize = function(c) {
          ...
          b.prototype.initialize.apply(this, null),
              ...
              this.width = 100,   // 容器的默认宽
              this.height = 100,  // 容器的默认高
              this.childs = [],
              this.alpha = .5,
              this.dragable = !0,
              this.childDragble = !0,
          ...
          var e = 'childNodes,textPosition,text'.split(',');
          this.serializedProperties = this.serializedProperties.concat(e);
        },
            this.initialize(c),
            ...
            this.paint = function(a) {
              this.visible && (this.layout && this.layout(this, this.childs),
                  ...
                  null == this.borderRadius || 0 == this.borderRadius ?
                      ...
                      a.JTopoRoundRect(this.x, this.y, this.width, this.height,
                          this.borderRadius),
                  a.fill(),
                  a.closePath(),
                  this.paintText(a),
            ...
            this.paintBorder = function(a) {
              if (0 != this.borderWidth) {
                ...
                var b = this.borderWidth / 2;
                null == this.borderRadius || 0 == this.borderRadius ?
                    a.rect(this.x - b, this.y - b,
                        this.width + this.borderWidth,
                        this.height + this.borderWidth) :
                    a.JTopoRoundRect(this.x - b, this.y - b,
                        this.width + this.borderWidth,
                        this.height + this.borderWidth, this.borderRadius),
                    a.stroke(),
                    a.closePath();
    ...
    function(a) {
      ...
      function gridLayout(a, b) {
        return function(c) {
          var d = c.childs;
          if (!(d.length <= 0))
            for (var e = c.getBound(), f = d[0], g = (e.width - f.width) /
                b, h = (e.height - f.height) / a, i = (d.length,
                0), j = 0; a > j; j++)
              for (var k = 0; b > k; k++) {
                var l = d[i++],
                    m = e.left + g / 2 + k * g,
      ...
      function flowLayout(a, b) {
        ...
        null == b && (b = 0),
            function(c) {
              var d = c.childs;
              if (!(d.length <= 0))
                for (var e = c.getBound(), f = e.left, g = e.top, h = 0; h <
                d.length; h++) {
                  var i = d[h];
      ...
      function autoBoundLayout() {
        return function(a, b) {
          if (b.length > 0) {
            for (var c = 1e7, d = -1e7, e = 1e7, f = -1e7, g = d - c, h = f -
                e, i = 0; i < b.length; i++) {
              var j = b[i];
              j.x <= c && (c = j.x),
              j.x >= d && (d = j.x),
      ...
      function treeLayout(b, c, d) {
        return function(e) {
          function f(f, g) {
            for (var h = a.layout.getTreeDeep(f, g), k = j(f, g), l = k['' +
            h].nodes, m = 0; m < l.length; m++) {
              var n = l[m],
                  o = (m + 1) * (c + 10),
                  p = h * d;
            ...
            for (var q = h - 1; q >= 0; q--)
              for (var r = k['' + q].nodes, s = k['' + q].childs, m = 0; m <
              r.length; m++) {
                var t = r[m]
                    ,
                    u = s[m];
                ...
                m > 0)
                  if ('down' == b || 'up' == b) {
                    if (t.x < r[m - 1].x + r[m - 1].width)
                      for (var v = r[m - 1].x + r[m - 1].width +
                          c, w = Math.abs(v - t.x), x = m; x < r.length; x++)
                        i(e.childs, r[x], w, 0);
                  } else if (('left' == b || 'right' == b) && t.y < r[m - 1].y +
                      r[m - 1].height)
                    for (var y = r[m - 1].y + r[m - 1].height + c, z = Math.abs(
                        y - t.y), x = m; x < r.length; x++)
                      i(e.childs, r[x], 0, z);
              }
          }
      ...
      function adjustPosition(currNode, nodeChilds, event) {
        if (currNode.layout && currNode.layout.on) {
          ...
          if ('circle' == d) {
            ...
            e = n(currNode.cx, currNode.cy, nodeChilds.length, f,
                currNode.layout.beginAngle, currNode.layout.endAngle);
          } else if ('tree' == d) {
            var g = c.width || 50,
                h = c.height || 50,
                i = c.direction;
            e = o(currNode.cx, currNode.cy, nodeChilds.length, g, h, i);
          } else if ('auto' == d && currNode && currNode instanceof
              JTopo.Node && event && event.target instanceof JTopo.Node) {
            if (currNode.selectedLocation) {
              //纪录节点最后一次移动完成时的坐标
              editor.lastMovedX = currNode.selectedLocation.x + event.dx -
                  currNode.x;
              editor.lastMovedY = currNode.selectedLocation.y + event.dy -
                  currNode.y;
            }
            //子节点同步移动
            nodeChilds.forEach(function(n) {
              //对于有多个节点指向的情况，为避免重复位移，每次移动幅度按比例缩小
              n.setLocation(n.x + editor.lastMovedX /
                  (n.inLinks.length > 0 ? n.inLinks.length : 1),
                  n.y + editor.lastMovedY /
                  (n.inLinks.length > 0 ? n.inLinks.length : 1));
            });
          } else {
            if ('grid' != d)
              return;
            e = m(currNode.x, currNode.y, c.rows, c.cols, c.horizontal || 0,
                c.vertical || 0);
          }
      ...
      function getNodeChilds(scene, rootNode) {
        for (var d = [], e = 0; e < scene.length; e++)
          scene[e] instanceof a.Link && scene[e].nodeA === rootNode &&
          d.push(scene[e].nodeZ);
        return d;
      }
            ...
            b.paint = function(a) {
              ...
              for (var e = 0, f = 0; f < this.datas.length; f++) {
                ...
                j > Math.PI / 2 && j <= Math.PI ?
                    ...
                    a.fillStyle = '#FFFFFF',
                    a.fillText(h, k, l),
                    a.moveTo(this.radius * Math.cos(j),
                        this.radius * Math.sin(j)),
            ...
            b.paint = function(a) {
              ...
              for (var e = 0; e < this.datas.length; e++) {
                ...
                a.fillStyle = '#FFFFFF',
                    ...
                    a.fillText(this.titles[e], g + (d - j) / 2,
                        this.height / 2 + k),
                    a.fill(),
                    a.closePath(),
                    a.restore();
      ...
      function d(a, c, d, e, f) {
        ...
        for (var i in c) {
          ...
          h[i] = {
            ...
            step: k / d * g,
            isDone: function(b) {
              var c = this.step > 0 && a[b] >= this.targetValue || this.step <
                  0 && a[b] <= this.targetValue;
              return c;
            },
          };
        }
              ...
              h.paint = function(a) {
                a.save(),
                    ...
                    null != this.image ?
                        a.drawImage(this.image, -this.width / 2,
                            -this.height / 2) :
                        (a.fillStyle = 'rgba(' + this.style.fillStyle + ',' +
                            this.alpha + ')',
                            a.rect(-this.width / 2, -this.height / 2,
