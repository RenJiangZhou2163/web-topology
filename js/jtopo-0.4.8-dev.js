                        ...
                        d.forEach(function (a) {
                            ...
                            if ('link' == d) {
                                ...
                                if (nodeA && nodeZ) {
                                    ...
                                    c.shadowOffsetX = editor.config.shadowOffsetX;
                                    c.shadowOffsetY = editor.config.shadowOffsetY;
                                    c.bundleGap = editor.config.linkBundleGap;
                                }
                            } else if ('container' == d) {
                                // 拓扑绘制-容器
                                if (a['childNodes']) {
                ...
                this.paint = function (a) {
                    if (this.image) {
                        ...
                        a.globalAlpha = this.alpha,
                            null != this.image.alarm && null != this.alarm ? a.drawImage(this.image.alarm, -this.width / 2,
                                -this.height / 2, this.width, this.height) : a.drawImage(this.image, -this.width / 2,
